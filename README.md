...
Use grep to find all instances of the name `the_trials_of_aghrial` in all the files and change them your project's name. Then add your contact info to `setup.py`.
